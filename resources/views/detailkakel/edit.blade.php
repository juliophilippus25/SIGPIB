        ...
        <div class="col-md-8">
            ...
            <div class="card card-default">
                <div class="card-header d-flex">
                    <h3 class="card-title">Form Ubah Anggota Keluarga {{ $det_kakel->anggota->nama }}</h3>
                </div>
                <!-- /.card-header -->
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2bs4 @error('sts_keluarga') is-invalid @enderror"
                                ...
                                <option value="Anak" @php if(($det_kakel->sts_keluarga)=='Anak') echo 'selected' @endphp>
                                    Anak</option>
                                <option value="Istri" @php if(($det_kakel->sts_keluarga)=='Istri') echo 'selected' @endphp>
                                    Istri</option>
                            </select>
                            @error('sts_keluarga')
