            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <a href="{{ route('detailpelkat.create', ['id' => $pelkat->id]) }}"
                                class="btn btn-primary btn-fw col-md-12"><i class="fa fa-plus"></i> Pengurus PelKat</a>
                        </div>

                        <div class="col-md-2">
                            <a href="{{ route('pelkat.download_satu', ['id' => $pelkat->id]) }}" target="_blank"
                                class="btn btn-success btn-fw col-md-12"><i class="fas fa-cloud-download-alt"></i> Cetak
                                PDF</a>
                        </div>
