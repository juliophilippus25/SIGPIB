...
<body>
    ...
    <p>
        @if ($pelkat->nama_pelkat == 'Pelayanan Anak')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '1')->count() }}
        @elseif ($pelkat->nama_pelkat == 'Persekutuan Teruna')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '2')->count() }}
        @elseif ($pelkat->nama_pelkat == 'Gerakan Pemuda')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '3')->count() }}
        @elseif ($pelkat->nama_pelkat == 'Persekutuan Kaum Perempuan')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '4')->count() }}
        @elseif ($pelkat->nama_pelkat == 'Persekutuan Kaum Bapak')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '5')->count() }}
        @elseif ($pelkat->nama_pelkat == 'Persekutuan Kaum Lanjut Usia')
            Total Anggota Pengurus: {{ $det_pelkat->where('id_pelkat', '6')->count() }}
        @endif
    </p>
</body>
