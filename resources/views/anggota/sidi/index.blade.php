        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="{{ route('sidi.create') }}" class="btn btn-primary btn-fw col-md-12"><i
                        ...
                        {{-- <div class="col-md-2">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <a class="dropdown-item" target="_blank" href="{{ route('kakel.download_sekwil2_pdf') }}">
                                    ...
                                    <a class="dropdown-item" target="_blank" href="{{ route('kakel.download_sekwil3_pdf') }}">
                        ...
                        <tbody>
                            <tr>
                                @forelse($sidi as $data)
                                    ...
                                    <td>
                                        <a href="{{ route('sidi.tampil_detail', ['id' => $data->id]) }}"
                                            class="btn btn-primary btn-sm" title="Lihat Detail"><i
                                                class="fa fa-eye"></i></a>
                                        {{-- <a href="{{ route('sidi.download', ['id' => $data->id]) }}" target="_blank" class="btn btn-success btn-sm" title="Unduh" ><i class="fas fa-cloud-download-alt"></i></a> --}}
                                        <button type="button" class="btn btn-danger btn-sm" title="Hapus Data"
                                            data-toggle="modal" data-target="#modalDelete_{{ $data->id }}"><i
                                                class="fa fa-trash"></i></button>

                                        <!-- Modal -->
                                        <form method="POST" action="{{ route('sidi.hapus', ['id' => $data->id]) }}">
