        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <a href="<?php echo e(route('kakel.create')); ?>" class="btn btn-primary btn-fw col-md-12"><i
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="dropdown-menu" x-placement="bottom-start"
                                ...
                                <a class="dropdown-item" target="_blank" href="<?php echo e(route('kakel.download_sekwil1_pdf')); ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('detailkakel.index', ['id' => $data->id])); ?>"
                                            class="btn btn-primary btn-sm" title="Lihat Detail"><i
                                                class="fa fa-eye"></i></a>
                                        <a href="<?php echo e(route('kakel.tampil_ubah', ['id' => $data->id])); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SIGPIB\resources\views/baptis/index.blade.php ENDPATH**/ ?>