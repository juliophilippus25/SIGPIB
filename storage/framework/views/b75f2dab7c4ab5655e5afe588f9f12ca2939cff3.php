...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-default">
            ...
            <form action="<?php echo e(route('anggota.simpan_perbarui', ['id' => $anggota->id])); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kode_anggota" id="kode_anggota" value="<?php echo e($anggota->kode_anggota); ?>" readonly>
                            </div>
...
unset($__errorArgs, $__bag); ?>" name="nama" id="nama" placeholder="Masukkan Nama Lengkap" value="<?php echo e(old('nama', $anggota->nama)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="radio" name="jk" value="Laki-laki" <?php if(($anggota->jk)=='Laki-laki') echo 'checked' ?>> Laki-laki
                                &nbsp;
                                <input type="radio" name="jk" value="Perempuan" <?php if(($anggota->jk)=='Perempuan') echo 'checked' ?>> Perempuan
                                <br>
                                <?php $__errorArgs = ['jk'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>" name="tempat_lahir" id="tempat_lahir" placeholder="Masukkan Tempat Lahir" value="<?php echo e(old('tempat_lahir', $anggota->tempat_lahir)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('tgl_lahir', $anggota->tgl_lahir)); ?>">
                                    </div>
...
unset($__errorArgs, $__bag); ?>" name="no_hp" id="no_hp" placeholder="Masukkan Nomor Handphone" value="<?php echo e(old('no_hp', $anggota->no_hp)); ?>" onkeypress="return isNumberKey(event)">
...
unset($__errorArgs, $__bag); ?>" name="pekerjaan" id="pekerjaan" placeholder="Masukkan Pekerjaan" value="<?php echo e(old('pekerjaan', $anggota->pekerjaan)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="radio" name="sts_keluarga" value="Ya" <?php if(($anggota->sts_keluarga)=='Ya') echo 'checked' ?>> Ya
                                &nbsp;
                                <input type="radio" name="sts_keluarga" value="Tidak" <?php if(($anggota->sts_keluarga)=='Tidak') echo 'checked' ?>> Tidak
                                <br>
...
unset($__errorArgs, $__bag); ?>" name="provinsi" id="provinsi"  placeholder="Masukkan Provinsi" value="<?php echo e(old('provinsi', $anggota->provinsi)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="kabupaten" id="kabupaten"  placeholder="Masukkan Kabupaten" value="<?php echo e(old('kabupaten', $anggota->kabupaten)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="kecamatan" id="kecamatan"  placeholder="Masukkan Kecamatan" value="<?php echo e(old('kecamatan', $anggota->kecamatan)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="kelurahan" id="kelurahan"  placeholder="Masukkan Kelurahan" value="<?php echo e(old('kelurahan', $anggota->kelurahan)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="alamat" id="alamat"  placeholder="Masukkan Alamat" value="<?php echo e(old('alamat', $anggota->alamat)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <input type="radio" name="goldar" value="A" <?php if(($anggota->goldar)=='A') echo 'checked' ?>> A
                                &nbsp;
                                <input type="radio" name="goldar" value="B" <?php if(($anggota->goldar)=='B') echo 'checked' ?>> B
                                &nbsp;
                                <input type="radio" name="goldar" value="O" <?php if(($anggota->goldar)=='O') echo 'checked' ?>> O
                                &nbsp;
                                <input type="radio" name="goldar" value="AB" <?php if(($anggota->goldar)=='AB') echo 'checked' ?>> AB
                                <br>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <img id="preview" class="product" width="150" height="150" src="<?php echo e(asset('storage/images/anggota/'.$anggota->gambar)); ?>"/>
