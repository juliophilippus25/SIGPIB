...
unset($__errorArgs, $__bag); ?>" name="sts_keluarga" style="width: 100%;">
                      ...
                      <option value="Anak" <?php if(($det_kakel->sts_keluarga)=='Anak') echo 'selected' ?>>Anak</option>
                      <option value="Istri" <?php if(($det_kakel->sts_keluarga)=='Istri') echo 'selected' ?>>Istri</option>
                  </select>
