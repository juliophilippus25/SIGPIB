                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="kode_anggota" id="kode_anggota" value="<?php echo e($kodeAnggota); ?>" readonly>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input <?php $__errorArgs = ['srt_atestasi'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="customFile" name="srt_atestasi">
                                    <label class="custom-file-label" for="customFile">Pilih file</label>
                                </div>
