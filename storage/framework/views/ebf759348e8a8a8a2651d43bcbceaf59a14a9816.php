    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card card-default">
            <div class="card-header d-flex">
                <h3 class="card-title">Data Anggota Jemaat</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-2">
                        <a href="<?php echo e(route('anggota.tambah')); ?>" class="btn btn-primary btn-fw col-md-12"><i class="fa fa-plus"></i> Anggota</a>
                    </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Modal Hapus -->
                                <form method="POST" action="<?php echo e(route('anggota.hapus', ['id' => $data->id])); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SIGPIB\resources\views/anggota/index.blade.php ENDPATH**/ ?>