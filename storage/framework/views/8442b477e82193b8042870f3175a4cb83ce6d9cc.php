...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('detailkakel.index', ['id' => $kakel->id])); ?>">Detail Kartu
                    Keluarga</a></li>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                <option value="Anak" <?php if(old('sts_keluarga') == 'Anak'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Anak
                                </option>
                                <option value="Istri" <?php if(old('sts_keluarga') == 'Istri'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Istri
                                </option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="<?php echo e(route('detailkakel.index', ['id' => $kakel->id])); ?>"
