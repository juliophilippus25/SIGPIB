...
<head>
    ...
    <title>SIGPIB | SURAT BAPTIS <?php echo e($baptis->anggota->kode_anggota); ?></title>
    <style type="text/css">
        .center {
            text-align: center;
        }
            ...
            <td>
                ...
                <?php else: ?>
                    <img id="preview" class="product" style="border-radius: 25px; padding: 20px;" width="150" height="150"
                        src="<?php echo e(public_path('storage/images/anggota/' . $baptis->anggota->gambar)); ?>" />
                <?php endif; ?>
            </td>
        </tr>
    </table>
    ...
    <table id="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo e($baptis->anggota->tempat_lahir); ?> / <?php echo e(Carbon\Carbon::parse($baptis->anggota->tgl_lahir)->isoFormat('D MMMM Y')); ?>
            ...
            <tr>
                ...
                <td>:</td>
                <td><?php echo e($baptis->anggota->pekerjaan); ?></td>
            </tr>
            <tr>
                <td class="bold">No HP</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->no_hp); ?></td>
            </tr>
            <tr>
                <td class="bold">Alamat</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->alamat); ?></td>
            </tr>
            <tr>
                <td class="bold">Provinsi</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->provinsi); ?></td>
            </tr>
            <tr>
                <td class="bold">Kota/Kabupaten</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->kabupaten); ?></td>
            </tr>
            <tr>
                <td class="bold">Kecamatan</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->kecamatan); ?></td>
            </tr>
            <tr>
                <td class="bold">Kelurahan/Desa</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->kelurahan); ?></td>
            </tr>
            <tr>
                <td class="bold">Golongan Darah</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->goldar); ?></td>
            </tr>
            <tr>
                <td class="bold">Kepala Keluarga</td>
                <td>:</td>
                <td><?php echo e($baptis->anggota->sts_keluarga); ?></td>
            </tr>
        </tbody>
...
<?php /**PATH C:\xampp\htdocs\SIGPIB\resources\views/laporan/baptis/surat_baptis.blade.php ENDPATH**/ ?>